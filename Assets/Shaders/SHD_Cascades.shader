...
////// Specular:
                ...
                float node_1554 = 0.5;
                float3 node_916 = (lerp((lerp((_MainColor.rgb+_WaterTex_var.g),(_MainColor.rgb*_WaterTex_var.g),0.5)+_WaterTex_var.b),_IceColor.rgb,step(0.2,(saturate((lerp(lerp(node_2717.rgb,float3(node_1554,node_1554,node_1554),node_1554),float3(i.uv0.g,i.uv0.g,i.uv0.g),node_1554)+_Gel))*_Gel)))*lerp(saturate((1.0 - (i.uv0.g*i.uv0.g))),1.0,_Degrade));
                float3 diffuseColor = node_916; // Need this for specular when using metallic
...
////// Emissive:
                float3 emissive = (node_916*_Emissive);
/// Final Color:
