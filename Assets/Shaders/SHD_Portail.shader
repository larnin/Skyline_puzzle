...
/// Final Color:
                ...
                fixed4 finalRGBA = fixed4(finalColor,(lerp(_BaseTex_var.r,1.0,_EffectIntenisty)*_Alpha_var.r));
...
/// Final Color:
                ...
                float4 _BaseTex_var = tex2D(_BaseTex,TRANSFORM_TEX(node_3818, _BaseTex));
                float4 _Alpha_var = tex2D(_Alpha,TRANSFORM_TEX(i.uv0, _Alpha));
                fixed4 finalRGBA = fixed4(finalColor * (lerp(_BaseTex_var.r,1.0,_EffectIntenisty)*_Alpha_var.r),0);
                UNITY_APPLY_FOG(i.fogCoord, finalRGBA);
                return finalRGBA;
            }
            ENDCG
